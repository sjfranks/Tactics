...
const CLASSES={
  fighter:{name:'Brakka',rival:'Grask',title:'Fighter',role:'Defender',hp:34,grow:5,speed:3,attrs:{M:3,F:1,W:0,P:1},prime:'M',second:'P',steady:1,
    ...
    trait:'Sentinel: her parting blows stop a foe in its tracks and mark it. A marked foe that attacks anyone else takes a hindrance, and she strikes it if it stands beside her.',
  ...
  rogue:{name:'Vex',rival:'Shade',title:'Rogue',role:'Striker',hp:22,grow:3,speed:4,attrs:{M:0,F:3,W:1,P:1},prime:'F',second:'W',nimble:true,
    ...
    trait:'Nimble: never provokes parting blows. Sneak Attack: extra damage on an attack with a boon. She gains a boon when an ally stands beside her target.',
    pro:'she',mom:['+1 when she lands a sneak attack (an attack with a boon).']},
...
const GLOSS={
  ...
  attack:{name:'Attack Roll',forms:['attack roll','attack rolls'],text:'Roll three six-sided dice (3d6) and add the attribute the power uses. A total of 10 or less is a Graze, 11 to 14 is a Hit, and 15 or more is a Critical hit. Rolling 16 or more on the dice alone is always a Critical hit. Each boon adds 2 and each hindrance subtracts 2.'},
