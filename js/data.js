...
const POWERS={
  /* ---- Fighter ---- */
  grind:{c:'fighter',lv:1,a:'M',name:'Grinding Strike',cost:0,tgt:'enemy',range:1,dmg:[3,6,9],mark:1,eff:{push:[0,0,1]},desc:'Mark the foe. On a crit: push 1.'},
  ...
  meteor:{c:'wizard',lv:9,a:'W',name:'Meteor Swarm',cost:6,tgt:'tile',range:6,area:2,aff:'foe',dmg:[5,8,12],eff:{prone:[0,1,1]},fx:'fire',igniteCenter:true,desc:'Range 6, 5x5 blast. On a hit: prone.'},
...
const MON={
  ...
  hobgob:{name:'Hobgoblin Guard',role:'Defender',act:0,art:'hobgoblin',hp:22,speed:3,attrs:{M:2,F:1,W:0,P:1},steady:1,cost:3,acts:[{name:'Spear Wall',a:'M',range:1,dmg:[3,5,7],eff:{mark:[0,1,1]}}],note:'On a hit: marks the hero.'},
  orc:{name:'Orc Brute',role:'Brute',act:0,art:'orc',hp:28,speed:3,attrs:{M:3,F:0,W:0,P:0},cost:3,savage:true,acts:[{name:'Greataxe',a:'M',range:1,dmg:[3,6,9],eff:{push:[0,1,2]}}],note:'Savage: +2 damage to heroes at half health or less.'},
  ...
  brood:{name:'Brood Mother',plural:'brood mothers',role:'Champion',act:1,art:'broodmother',hp:52,sz:2,speed:3,attrs:{M:3,F:2,W:0,P:0},steady:2,cost:6,summon:'spiderlings',summonN:1,summonCap:2,summonVerb:'hatches',summonCall:'Hatch!',
  ...
  zombie:{name:'Barrow Zombie',role:'Brute',act:1,art:'zombie',hp:32,speed:2,attrs:{M:2,F:0,W:0,P:0},undead:true,cost:3,acts:[{name:'Grave Grasp',a:'M',range:1,dmg:[4,6,9],eff:{root:[0,1,1]}}],note:'On a hit: rooted.'},
...
const GLOSS={
  ...
  mark:{name:'Marked',forms:['marks','marked','mark'],text:'A marked creature has disadvantage on attacks that don\'t include whoever marked it. A fighter who marks a foe strikes it when it attacks someone else while beside her.'},
  ...
  prone:{name:'Prone',forms:['prone'],text:'Knocked down. Melee attacks against it have advantage; its own attacks have disadvantage; its speed is halved. Lasts until the end of its next turn.'},
  ...
  expose:{name:'Exposed',forms:['exposed','expose'],text:'Attacks against it have advantage.'},
  bless:{name:'Blessed',forms:['blessed','bless'],text:'Attacks with advantage.'},
  ...
  sneak:{name:'Sneak Attack',forms:['sneak attack'],text:'The rogue deals 2 extra damage (more at higher levels) on any attack with advantage.'},
