...
@media (orientation:portrait){.battlefield-viewport{inset:0;height:100dvh}.battlefield-frame{top:0!important;left:0!important;width:100%!important;height:auto!important;aspect-ratio:3/4;overflow:hidden;background:#000;transform:none!important}.battlefield{width:100%!important;height:100%!important;background:#000}.game-board{display:block;width:100%!important;height:100%!important;max-height:none!important;margin:0!important}.hud-left,.hud-right{bottom:max(12px,env(safe-area-inset-bottom))}}
@media (orientation:landscape){.battlefield-viewport{inset:0;padding-bottom:116px}.battlefield-frame{top:0;left:50%!important;right:auto;width:auto!important;height:calc(100dvh - 116px)!important;aspect-ratio:3/4;max-width:100vw;transform:translateX(-50%)}.battlefield{height:100%;width:100%}.game-board{height:100%!important;width:100%!important;max-height:calc(100dvh - 116px);max-width:100vw;margin:0 auto}.initiative-dock{top:auto!important;bottom:max(2px,env(safe-area-inset-bottom));left:20%!important;right:20%!important;height:108px}.initiative-rail{height:108px;padding-top:27px;padding-bottom:12px}.hud-left,.hud-right{bottom:max(16px,env(safe-area-inset-bottom));display:flex;gap:9px}.hud-left{left:max(18px,env(safe-area-inset-left))}.hud-right{right:max(18px,env(safe-area-inset-right))}.hud-circle{width:48px;height:48px}}
`,map:null};
  }
};
