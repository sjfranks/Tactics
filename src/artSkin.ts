...
function skinBoard(){
  ...
  if(tiles&&!styled.has(tiles)){
    ...
    const im=document.createElementNS(NS,'image');im.setAttribute('href',BATTLEFIELD_BACKGROUND);im.setAttribute('x','0');im.setAttribute('y','0');im.setAttribute('width','480');im.setAttribute('height','640');im.setAttribute('preserveAspectRatio','xMidYMid slice');im.setAttribute('class','terrain-background');im.style.pointerEvents='none';tiles.insertBefore(im,tiles.firstChild);styled.add(tiles);
  }
