...
function token(c:CanvasRenderingContext2D,g:SVGGElement){
 ...
 if(g.querySelector('.shield-mark')){c.save();c.translate(5.2,-6.2);c.scale(.7,.7);c.fillStyle='#f5f7fa';c.beginPath();c.moveTo(0,-3);c.lineTo(3,-2);c.lineTo(2.5,1);c.quadraticCurveTo(1.5,3,0,4);c.quadraticCurveTo(-1.5,3,-2.5,1);c.lineTo(-3,-2);c.closePath();c.fill();c.restore()}c.restore()
}
